...
Original file is located at
    https://colab.research.google.com/drive/1PUIgSVRMttkmXcaZcqQpdsfDDtscQnm9
...
model = MLPRegressor(activation= 'identity', batch_size= 32, hidden_layer_sizes= (34), learning_rate = 'constant', solver= 'adam')
