...
Original file is located at
    https://colab.research.google.com/drive/1kkKofOjZvMYfBvYLx7dGLnSuSSNsCU1n
...
model = BaggingRegressor(estimator=DecisionTreeRegressor(criterion= 'friedman_mse', max_depth = 4),
