...
Original file is located at
    https://colab.research.google.com/drive/1NKPX_3eEd1DDpbOdClzQHHMuRwItjPGe
...
reg = StackingRegressor(
    ...
    final_estimator=MLPRegressor(activation= 'identity', batch_size= 32, hidden_layer_sizes= (34), 
